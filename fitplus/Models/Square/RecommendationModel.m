...
+ (void)fetchOneTopicRecentTrend:(NSString *)topicId page:(NSInteger)page handler:(RequestResultHandler)handler {
    [[FetchOneTopicRecentRequest new] request:^BOOL(FetchOneTopicRecentRequest *request) {
        request.page = page;
        request.topicId = topicId;
        return YES;
