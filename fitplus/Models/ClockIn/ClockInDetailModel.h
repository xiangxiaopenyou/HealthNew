...
@property (copy, nonatomic) NSString<Optional> *foodName;
@property (assign, nonatomic) float sportsEnergy;
@property (copy, nonatomic) NSString<Optional> *sportsName;
@property (copy, nonatomic) NSString<Optional> *clockinTag;
...
@property (copy, nonatomic) NSNumber<Optional> *count_day;
@property (copy, nonatomic) NSNumber<Optional> *flag;
@property (copy, nonatomic) NSNumber<Optional> *ispublic;
