...
@property (copy, nonatomic) NSString<Optional> *labelids;
@property (copy, nonatomic) NSString<Optional> *enable;
@property (copy, nonatomic) NSString<Optional> *portraitUrl;
