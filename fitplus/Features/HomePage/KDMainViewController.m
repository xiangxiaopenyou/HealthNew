...
@interface KDMainViewController ()<UITabBarControllerDelegate, UINavigationControllerDelegate>
...
//    UIEdgeInsets imageInsets = UIEdgeInsetsMake(6, 0, -6, 0);
    ...
    UIImage *dryImage = [UIImage imageNamed:@"tab_button_fitness_normal"];
    UIImage *dryImageSel = [UIImage imageNamed:@"tab_button_fitness_pressed"];
    ...
    UIImage *messageImage = [UIImage imageNamed:@"tab_btn_circle_normal"];
    UIImage *messageImageSel = [UIImage imageNamed:@"tab_btn_circle_pressed"];
    ...
    UIViewController *squareViewController = [[UIStoryboard storyboardWithName:@"Square" bundle:nil] instantiateViewControllerWithIdentifier:@"HomepageView"];
...
//    groupListViewController.tabBarItem = item_group;
    ...
    UIViewController *messageListViewController = [[UIStoryboard storyboardWithName:@"Community" bundle:nil] instantiateViewControllerWithIdentifier:@"CommunityHomepageView"];
    ...
    UIViewController *homepageViewController = [[UIStoryboard storyboardWithName:@"Information" bundle:nil] instantiateViewControllerWithIdentifier:@"MyHomepageView"];
    homepageViewController.tabBarItem = item_homepage;
    
    self.viewControllers = @[squareViewController, drysalteryViewController, messageListViewController, homepageViewController];
...
- (void)receivedMessages:(NSNotification *)notification {
    ...
    UIViewController<KDTabbarProtocol> *vc = [self.viewControllers objectAtIndex:2];
    vc.tabBarItem.badgeValue = [NSString stringWithFormat:@"%@", @(messageNum)];
}
