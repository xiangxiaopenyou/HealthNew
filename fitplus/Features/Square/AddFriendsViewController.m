...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        ...
        NSString *portrait = [[NSUserDefaults standardUserDefaults] stringForKey:UserHeadportrait];
        AppDelegate *appDelegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
        [appDelegate shareWithWeChatFriends:[NSString stringWithFormat:@"%@邀请您一起来健身", nickname] Description:@"跟我一起加入健身坊,和帅哥美女一起来健身,来,约着动起来~" Url:@"http://jianshen.so" Photo:portrait];
    }
}
