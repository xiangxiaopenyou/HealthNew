...
- (void)viewDidAppear:(BOOL)animated {
    ...
    for (NSInteger i = 0; i < 3; i ++) {
        ...
        if (SCREEN_HEIGHT > 480) {
            image.image = [UIImage imageNamed:[NSString stringWithFormat:@"guide_background_big_%@", @(i + 1)]];
        } else {
            image.image = [UIImage imageNamed:[NSString stringWithFormat:@"guide_background_small_%@", @(i + 1)]];
        }
