...
//    }
    ...
    [TakePhotoModel record:nil calories:0 image:_imageView.image tags:_tagArray content:_contentTExtView.text topicId:_topicId handler:^(id object, NSString *msg) {
