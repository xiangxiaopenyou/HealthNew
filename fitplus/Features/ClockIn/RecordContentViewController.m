...
- (IBAction)record:(id)sender {
    ...
    [class record:_selectedGoods calories:_calories.doubleValue image:_thumbImageView.image tags:_tagArray content:_contentTextView.text topicId:nil handler:^(id object, NSString *msg) {
