...
+ (NSString *)getIntervalDateString:(NSString *)string {
...
+ (BOOL)comparaTwoDate:(NSDate *)firstDate second:(NSDate *)secondDate {
    NSTimeInterval firstInterval = [firstDate timeIntervalSince1970] * 1;
    NSTimeInterval secondInterval = [secondDate timeIntervalSince1970] * 1;
    NSTimeInterval chaIntercal = firstInterval - secondInterval;
    if (chaIntercal > 0) {
        return YES;
    } else {
        return NO;
