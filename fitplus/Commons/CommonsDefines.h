...
extern NSString *const IsFirstOpenCommunity;
extern NSString *const EncourageDryTime;
extern NSString *const SkillDryTime;
extern NSString *const KnownledgeDryTime;
extern NSString *const DietDryTime;
